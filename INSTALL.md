...
below. If you decide to try the Gitpod route, it may still be a good
idea to read through [the instructions near the end that demonstrate,
briefly, how to run
Cryptol](INSTALL.md#running-from-a-direct-install).
